...
def list_trivial_fields_PoliciesJsonDocumentConnection(ds: DSLSchema):
    """ List all trivial fields of the PoliciesJsonDocumentConnection type """
    return (
    )
def list_trivial_fields_PolicyJsonDocumentEdge(ds: DSLSchema):
    """ List all trivial fields of the PolicyJsonDocumentEdge type """
    return (
    )
def list_trivial_fields_PolicyJsonData(ds: DSLSchema):
    """ List all trivial fields of the PolicyJsonData type """
    return (
        ds.PolicyJsonData.externalId,
        ds.PolicyJsonData.documentJson,
        ds.PolicyJsonData.externalPolicyType,
        ds.PolicyJsonData.externalPolicyName,
    )
...
def list_trivial_fields_UserScopeRoleData(ds: DSLSchema):
    ...
    return (
        ds.UserScopeRoleData.policyId,
        ds.UserScopeRoleData.userId,
        ds.UserScopeRoleData.scopeId,
        ds.UserScopeRoleData.policyType,
