...
def list_trivial_fields_TargetGroupBeforeGoLiveProfileSelectionData(ds: DSLSchema):
    """ List all trivial fields of the TargetGroupBeforeGoLiveProfileSelectionData type """
    return (
    )
